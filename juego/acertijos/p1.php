    ...
    <div id="w">
        ...
        <div id="pista" class="hint">
            <div class="hint-content" id="pist">
                <a href="">X</a>
                <h2>AYUDA</h2>
                <p>Fue un matematico y computador muy importante...</p>
            </div> 
        ...
        <div class="div1">
            <p>Turing era conocido como...
                <br>
                <br> a. Cientifico humano - analitico.
                <br> b. Neo - Nazi.
                <br> c. Un padre de la ciencia.
                <br> d. Un traidor Nazi
            </p>
        </div>
        <div class="div2">
            <form action="#" name="f1">
                <div id="f1">Solución: <input  autocomplete="off" type="text" name="respuesta" maxlength="20" ><input type="button" name="comprobar" value="Comprobar" onClick="comprobarClave1()"></div> 

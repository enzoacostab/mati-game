...
<div class="mdp">
    ...
    <div id="w">
        ...
        <div id="pista" class="hint">
            ...
            <a href="">X</a>
            <h2>AYUDA</h2>
            <p> Aquella disputa se desató durante la segunda guerra mundial...
            </p>
        </div> 
    ...
    <div class="div1">
        <p> Turing ayudo a decifrar los codigos de...
            <br>a. Los Nazis
            <br>b. La CIA
            <br>c. El FBI
            <br>d. El ISIS
    ...
    <div class="div2">
        <form action="#" name="f1">
            <div id="f1">Solución: <input autocomplete="off" type="text" name="respuesta" maxlength="20" ><input type="button" name="comprobar" value="Comprobar" onClick="comprobarClave3()"></div>

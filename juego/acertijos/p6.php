...
<div class="mdp">
    ...
    <div id="w">
        ...
        <div id="pista" class="hint">
            ...
            <h2>AYUDA</h2>
            <p>Cifrado Atbash: 
                Sustituyes cada letra del abecedario por su abecedario a la inversa.
                <br>
                <br>Ej: Arbol A = Z   R = I   B = Y  O = L  L = O 
                <br> Arbol = ZIYLO  
                </p>
        </div>  
    ...
    <div class="div1">
        <p> UVORXRGZXRLNVH SZH ZBFWZWL Z ÑZGR Z VHXZKZI</p>
    </div>
    <div class="div2">
        <form action="#" name="f1">
            <div id="f1">Solución: <input autocomplete="off" type="text" name="respuesta"  ><input type="button" name="comprobar" value="Comprobar" onClick="comprobarClave6()"></div> 
            <h1 id="incorrecta">La solucion no es correcta</h1><h1 id="correcta">La solucion es correcta</h1>
        </form>
    </div>
    <div class="div3">
        <p>A B C D E F G H I J K L M N Ñ O P Q R S T U V W X Y Z. <br>Z Y X W V U T S R Q P O Ñ N M L K J I H G F E D C B A.</p>

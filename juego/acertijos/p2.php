...
<div class="mdp">
    ...
    <div id="pista" class="hint">
        <div class="hint-content" id="pist">
            ...
            <p>
                Cifrado Cesar: 
                Sustituyes cada letra del abecedario por una letra especifica segun el numero de desplazamientos.
                <br>Ej: 
                <br>Sustitucion de desplazamiento 1:
                <br> Arbol   A = B   R = S   B = C  O = P  L = M 
                <br> Arbol = BSCPM  
                <br>
                <br> ¡UTILIZA EL NUMERO DADO ANTERIORMENTE (4)!
            </p>
        </div>  
    ...
    <div class="div1">
        <p>Desencripta el nombre del proyecto en el que Turing trabajaba <br> decifrando el siguiente codigo...
            <br>
            <br>AJECIW
        </p>
    </div>
    <div class="div2">
        <form action="#" name="f1">
            <div id="f1">Solución: <input autocomplete="off" type="text" name="respuesta" maxlength="20" ><input type="button" name="comprobar" value="Comprobar" onClick="comprobarClave2()"></div> 

...
<div class="mdp">
    ...
    <div id="w">
        ...
        <div id="pista" class="hint">
            ...
            <p>Cifrado Cesar: 
                ...
                <br> Arbol = BSCLM  
                <br>
                <br> ¡UTILIZA EL NUMERO DADO ANTERIORMENTE (20)!</p>
        </div>  
    ...
    <div class="div1">
        <p>El nombre de aquel hombre capaz de desencriptar los mensajes Nazis fue...
            <br> TETG NÑLBGZ
        </p>
    </div>
    <div class="div2">
        <form action="#" name="f1">
            <div id="f1">Solución: <input autocomplete="off" type="text" name="respuesta" maxlength="20" ><input type="button" name="comprobar" value="Comprobar" onClick="comprobarClave4()"></div> 
